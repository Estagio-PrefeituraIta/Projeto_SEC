...
while ($dados = mysqli_fetch_assoc($result)) {
    ...
    // Função para ler um arquivo CSV e retornar um array com os dados
    ...
    // Lê o arquivo CSV
    $dados = lerCsv('../data/clients/ficha_fin2005_2010.csv');

    // Percorre os dados do arquivo
    foreach ($dados as $linha) {
        // Verifica se a linha atende aos seus critérios de filtro
        if (strcasecmp($linha[4], $ano) === 0 && $linha[5] == $mes && $linha[0]  == 'FEC14/44558'){
    ...
    if ($numero_resultados === 0) {
        echo "Nenhum registro encontrado para o nome '$usuario' e o mês '$mes'.";
    } else {
        // Exibe os resultados
        foreach ($resultados as $linha) {
        // echo "Matricula: " . $linha[0] . "<br>";
        // echo "Nome: " . $linha[1] . "<br>";
        // echo "Ano: " . $linha[4] . "<br>";
        // echo "Mes: " . $linha[5] . "<br>";
        // echo "$usuario =>" . $linha[1] . "<br>";
        // echo "P ou D:". $linha[8] . "<br>";
        // echo "<br>";
        echo "<tr>
            <td>Cod: ". $linha[6] ."</td>
            <td>Descrição: " .$linha[7]. "</td>
            <td> Referencia: " .$linha[8] . "-". $linha[9]."</td>
        </tr>";
        }
